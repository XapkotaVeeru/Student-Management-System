...
public class TeacherController : ControllerBase
{
    ...
    public async Task<IActionResult> EnterMark(int examId, EnterMarkDto dto,
    ...
    public async Task<IActionResult> SubmitMark(int markId, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> EnterReExamMark(int applicationId, EnterReExamMarkDto dto,
        CancellationToken cancellationToken)
    {
        var command = new EnterReExamMarkCommand(applicationId, dto.MarksObtained, dto.MaxMarks);
